            ...
            <section class="wrapper site-min-height">
               <section class="panel">
                  <header class="panel-heading">
                     <span class="label label-primary">施 肥 日 历 表</span>
                  ...
                  <div class="panel-body">
                     <div class="adv-table editable-table ">
                        <div class="clearfix">
                           <div class="btn-group">
                              <a class="btn btn-success green" href="fertilizer_add.php">
                              增加施肥记录 <i class="fa fa-plus" ></i>
                              </a>
                           </div>
		                 ...
		                 <?php
	                       if($num=mysqli_num_rows($result))
	                      {
								...
								?>
									...
									<td align="center">
									<?php 
									 if($row['fertilizer_species']==0)  echo "氮肥";
                                      else if($row['fertilizer_species']==1)  echo "磷肥";
									   else echo "钾肥";
									?></td>
									<td align="center"><?php echo $row['fertilizer_yield'] ?>克</td>
									<td align="center">
									<?php 
									 if($row['fertilizer_weather']==0)  echo "晴天";
                                      else if($row['fertilizer_weather']==1)  echo "雨天";
									   else echo "阴天";
									?></td>
									<td align="center"><?php echo $row['fertilizer_temperature'] ?>℃</td>
									<td align="center"><?php echo $row['fertilizer_humidity'] ?>%</td>
										<td><img src="<?php echo $row['fertilizer_img']==''?'img/none.jpg':$row['fertilizer_img']; ?>" height="50" width="70"></td>
									<td align="center"><?php echo $row['fertilizer_introduce'] ?></td>
									<td><a class="label label-success" href="fertilizer_edit.php?fertilizer_id=<?php echo $row['fertilizer_id'] ?>" >修改</a>
									    <a class="label label-danger" href="fertilizer_delete.php?fertilizer_id=<?php echo $row['fertilizer_id'] ?>"> 删除</a> </td>
								</tr>
								<?php
									}
								}
