...
<html lang="en">
   ...
   <body>
                  ...
                  <div class="col-lg-12">
                     <section class="panel">
                        <header class="panel-heading">
                           <span class="btn btn-info">添加除虫记录</span>
                        ...
                        <div class="panel-body">
                           <form class="form-horizontal tasi-form" method="get" action="pesticide_save.php">	
                            ...
                            <div class="form-group">
                                 ...
                                 <div class="col-lg-10">
                                    <div class="row">
                                       <div class="col-lg-2">
                                          <input type="text" class="form-control" name="pesticide_time" placeholder="单位‘日’"  >
                                       </div>
                                    </div>
                                 </div>
                              </div>
					          ...
					          <div class="form-group">							  
                                 <label for="exampleInputFile" class="col-sm-2 control-label col-lg-2">图片上传</label>
								  <div class="col-lg-2">
                                 <input type="file" id="image2" class="button bg-blue margin-left" >
								  </div>
								   <div class="text">
							     ...
							     <div class="form-group">
                                 <label class="col-sm-2 control-label col-lg-2" >药剂种类</label>
                                 <div class="col-lg-10">
                                    <select class="form-control m-bot15"  name="pesticide_species">
                                       <option value="0">除虫剂</option>
                                       <option value="1">除草剂</option>                                    
                                    </select>
                                 </div>
                              </div>
							   ...
							   <div class="form-group">
                                 <label class="col-sm-2 control-label col-lg-2" >药剂量</label>
                                 <div class="col-lg-10">
                                    <div class="row">
                                       <div class="col-lg-2">
                                          <input type="text" class="form-control"  name="pesticide_yield" placeholder="单位’ml‘">
                                       </div>
                                    </div>
                                 </div>
                              </div>
							  <div class="form-group">
                                 ...
                                 <div class="col-lg-10">
                                    <div class="radio">
                                       <label>
                                       <input type="radio" name="pesticide_weather" id="pesticide_weather" value="0" checked>
                                      晴天
                                       </label>
                                    </div>
                                    ...
                                    <div class="radio">
                                       <label>
                                       <input type="radio" name="pesticide_weather" id="pesticide_weather" value="1">
                                      雨天
                                       </label>
                                    </div>
                                    <div class="radio">
                                       <label>
                                       <input type="radio" name="pesticide_weather" id="pesticide_weather" value="2">
                                      阴天
                                       </label>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-lg-10">
                                    <div class="row">
                                       <div class="col-lg-2">
                                          ...
                                          <input type="text" class="form-control"  name="pesticide_temperature" placeholder="单位’℃‘" >
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div class="col-lg-10">
                                    <div class="row">
                                       <div class="col-lg-2">
                                          <input type="text" class="form-control"    name="pesticide_humidity" placeholder="单位‘%‘" >
                                       </div>
                                    </div>
                                 </div>
                              </div>
									  ...
									  <div class="form-group">
                                 <label class="col-sm-9 control-label col-lg-2" >农药记录介绍</label>
								 
								   <div class="col-lg-8">
										  <textarea name="pesticide_introduce" id="pesticide_introduce"></textarea>
										  <div class="tips"></div>
										</div>
    ...
    <script type="text/javascript">
        var ue = UE.getEditor('pesticide_introduce');
    </script>
