                  ...
                  <li class="sub-menu">
                     ...
                     <ul class="sub">
                       <li><a href="all_list.php">田地总览表</a></li>
                        ...
                        <li ><a href="water.php">农药日历表</a></li>
                        <li class="active"><a href="water.php">施肥日历表</a></li>
...
$sql="UPDATE fertilizer SET fertilizer_species='".$_POST['fertilizer_species']."',fertilizer_yield='".$_POST['fertilizer_yield']."',fertilizer_weather='".$_POST['fertilizer_weather']."',fertilizer_temperature='".$_POST['fertilizer_temperature']."',fertilizer_humidity='".$_POST['fertilizer_humidity']."' WHERE fertilizer_id=".$_POST['fertilizer_id'];

if(mysqli_query($conn,$sql))
	echo '<i class="text-center"></i>修改成功';
else
	echo '<i class="text-center"></i>修改失败';
?> 
        </h1>
		  ...
		  <a href="fertilizer.php">
			...
			点击返回 
			 ...
			 <h4 class="text-center">页面自动 <a id="href" href="fertilizer.php">跳转</a> 等待时间： <span id="totalSecond">5</span>
          </div>
