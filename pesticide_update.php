            ...
            <div id="sidebar" class="nav-collapse">
               <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                     ...
                     <ul class="sub">
                        <li><a href="basic_table.php">田地总览表</a></li>
...
$sql="UPDATE pesticide SET pesticide_yield='".$_POST['pesticide_yield']."',pesticide_species='".$_POST['pesticide_species']."',pesticide_humidity='".$_POST['pesticide_humidity']."',pesticide_weather='".$_POST['pesticide_weather']."',pesticide_temperature='".$_POST['pesticide_temperature']."' WHERE pesticide_id=".$_POST['pesticide_id'];
...
?> 
		  ...
		  <a href="pesticide.php">
			...
			点击返回 
			 ...
			 <h4 class="text-center">页面自动 <a id="href" href="pesticide.php">跳转</a> 等待时间： <span id="totalSecond">5</span>
          </div>
