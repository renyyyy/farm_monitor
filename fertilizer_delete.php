            ...
            <section class="wrapper site-min-height">
               <section class="panel">
                  <header class="panel-heading">
                     <span class="label label-primary">肥料日历表</span>
...
$sql="DELETE FROM fertilizer where fertilizer_id=".$_GET['fertilizer_id'];
if(mysqli_query($conn,$sql))
	echo "删除成功！<a href='fertilizer.php'>返回</a>";
else
	echo "删除失败！<a href='fertilizer.php'>返回</a>";
?>
