...
<html lang="en">
   ...
   <body>
                  ...
                  <div class="col-lg-12">
                     <section class="panel">
                        <header class="panel-heading">
                           <span class="btn btn-info">添加浇水记录</span>
                        ...
                        <div class="panel-body">
                           <form class="form-horizontal tasi-form" method="post" action="water_save.php">	   
                            <div class="form-group">
                                 <label class="col-sm-2 control-label col-lg-2" >日期</label>
                                 <div class="col-lg-10">
                                    <div class="row">
                                       <div class="col-lg-2">
                                          <input type="text" class="form-control" name="water_time" id="water_time" placeholder="单位‘日’"  >
                                       </div>
                                    </div>
                                 </div>
                              </div>
					          ...
					          <div class="form-group">							  
                                 <label for="exampleInputFile" class="col-sm-2 control-label col-lg-2">图片上传</label>
								  <div class="col-lg-2">
                                 <input type="file" id="image3" name="image3" class="button bg-blue margin-left" >
								  </div>
								   <div class="text">
							   ...
							   <div class="form-group">
                                 <label class="col-sm-2 control-label col-lg-2" >浇水量</label>
                                 <div class="col-lg-10">
                                    <div class="row">
                                       <div class="col-lg-2">
                                          <input type="text" class="form-control" name="water_quantity" id="water_quantity" placeholder="单位’L‘">
                                       </div>
                                    </div>
                                 </div>
                              </div>
							  <div class="form-group">
                                 ...
                                 <div class="col-lg-10">
                                     <select class="form-control m-bot15"  name="water_weather" id="water_weather">
                                 ...
                                 <div class="col-lg-10">
                                    <div class="row">
                                       <div class="col-lg-2">
                                          ...
                                          <input type="text" class="form-control" name="water_temperature" id="water_temperature" placeholder="单位’℃‘" >
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div class="col-lg-10">
                                    <div class="row">
                                       <div class="col-lg-2">
                                          <input type="text" class="form-control"  name="water_humidity" id="water_humidity" placeholder="单位‘%‘" >
                                       </div>
                                    </div>
                                 </div>
                              </div>	
                                       <div class="form-group">
                                 <label class="col-sm-9 control-label col-lg-2" >浇水记录介绍</label>
								 
								   <div class="col-lg-8">
										  <textarea name="water_introduce" id="water_introduce"></textarea>
										  <div class="tips"></div>
										</div>
    ...
    <script type="text/javascript">
        var ue = UE.getEditor('water_introduce');
    </script>
