   ...
   <!-- BEGIN SECTION --> 
      <section id="container" class="">
        ...
        <!-- SIDEBAR TOGGLE BUTTON  END-->
            <a href="index.php" class="logo">农田<span>Farm admin</span></a>     
               ...
               <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                     ...
                     <ul class="sub">
                        ...
                        <li ><a href="pesticide.php">施肥日历表</a></li>
...
if(!empty($_FILES)){
	...
	$file_tmp_name=$_FILES['image2']['tmp_name'];
	$image_name="upload/".time().".".substr(strrchr($file_name, '.'), 1);
	move_uploaded_file($file_tmp_name, $image_name);
	}
}
$sql="INSERT INTO pesticide (pesticide_time,image2,pesticide_species,pesticide_yield,pesticide_weather,pesticide_temperature,pesticide_humidity,pesticide_introduce)VALUES('".$_POST['pesticide_time']."','".$_POST['pesticide_img']."','".$_POST['pesticide_species']."','".$_POST['pesticide_yield']."','".$_POST['pesticide_weather']."','".$_POST['pesticide_temperature']."','".$_POST['pesticide_humidity']."','".$_POST['pesticide_introduce']."')";
if(mysqli_query($conn,$sql))
	echo '<i class=""></i>添加浇水记录成功';
else
	echo '<i class=""></i>添加浇水记录失败';
?>  
   </h1>
          <div class="form-group col-lg-12">
		  <a href="pesticide_add.php">
            <button type="button" class="btn btn-info btn-lg">
			点击返回 
            </button>
			</a>
			 <h4 class="text-center">页面自动 <a id="href" href="pesticide_add.php">跳转</a> 等待时间： <span id="totalSecond">5</span>
          </div>
