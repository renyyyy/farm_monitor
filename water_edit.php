...
$sql="select * FROM water where water_id=".$_GET['water_id'];
                     ...
                     <div class="adv-table editable-table ">
                        ...
                        <table  class="table table-striped table-hover table-bordered" >
                           <thead>
                              <tr>
                                 <th>日期</th>
                                 <th class="hidden-phone">浇水量/L</th>
                                 ...
                                 <th>操作</th>
									  ...
									  <form method="post" class="form-x" action="water_update.php">  
									 <tr>
									<td align="center"><?php echo $row['water_id'] ?>日</td>
									<td><input type="text" class="form-control small" value="<?php echo $row['water_quantity'] ?>" name="water_quantity"  />
									    <input type="hidden" name="water_id" value="<?php echo $_GET['water_id'] ?>">
									  </td>
									  
									  <td>
			
 <select name="water_weather" class="form-control m-bot15" value="<?php echo $_GET['water_weather'] ?>">
	...
	<input type="hidden" name="water_id" value="<?php echo $_GET['water_id'] ?>">
									  ...
									  <td><input type="text" class="form-control small" value="<?php echo $row['water_temperature'] ?>" name="water_temperature" data-validate="required:请输入温度" />
									  <input type="hidden" name="id" value="<?php echo $_GET['water_id'] ?>">
									  </td>
									  <td><input type="text" class="form-control small" value="<?php echo $row['water_humidity'] ?>" name="water_humidity" data-validate="required:请输入湿度" />
									  <input type="hidden" name="id" value="<?php echo $_GET['water_id'] ?>">
									  </td>
									  
									<td><button class="label label-success" type="submit"> 提交</button></td>
									</form>
									<a  href="water_update.php?water_id=<?php echo $row['water_id'] ?>"><span class="label label-success"> 保存</a> </span>
									<a class="label label-danger" href="water_delete.php?water_id=<?php echo $row['water_id'] ?>"> 取消</a> </td>
								</tr>
