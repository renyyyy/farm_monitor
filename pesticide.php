            ...
            <section class="wrapper site-min-height">
               <section class="panel">
                  <header class="panel-heading">
                     <span class="label label-primary">农 药 日 历 表</span>
                  ...
                  <div class="panel-body">
                     <div class="adv-table editable-table ">
                        <div class="clearfix">
                           <div class="btn-group">
                              <a class="btn btn-success green" href="pesticide_add.php">
                              增加农药记录 <i class="fa fa-plus" ></i>
                              </a>
                           </div>
		                 ...
		                 <?php
	                       if($num=mysqli_num_rows($result))
	                      {
								...
								?>
									...
									<td align="center">
									<?php 
									 if($row['pesticide_species']==0)  echo "除虫剂";
                                      else if($row['pesticide_species']==1)  echo "除草剂";
									?></td>
									<td align="center"><?php echo $row['pesticide_yield'] ?>毫升</td>
									<td align="center">
									<?php 
									 if($row['pesticide_weather']==0)  echo "晴天";
                                      else if($row['pesticide_weather']==1)  echo "雨天";
									   else echo "阴天";
									?></td>
									<td align="center"><?php echo $row['pesticide_temperature'] ?>℃</td>
									<td align="center"><?php echo $row['pesticide_humidity'] ?>%</td>
													<td><img src="<?php echo $row['pesticide_img']==''?'img/none.jpg':$row['pesticide_img']; ?>" height="50" width="70"></td>
									<td align="center"><?php echo $row['pesticide_introduce'] ?></td>
									<td><a class="label label-success" href="pesticide_edit.php?pesticide_id=<?php echo $row['pesticide_id'] ?>" >修改</a>
									    <a class="label label-danger" href="pesticide_delete.php?pesticide_id=<?php echo $row['pesticide_id'] ?>"> 删除</a> </td>
								</tr>
								<?php
									}
								}
