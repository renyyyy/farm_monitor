...
$sql="UPDATE water SET water_quantity='".$_POST['water_quantity']."',water_weather='".$_POST['water_weather']."',water_temperature='".$_POST['water_temperature']."',water_humidity='".$_POST['water_humidity']."' WHERE water_id=".$_POST['water_id'];
...
?> 
		  ...
		  <a href="water.php">
			...
			点击返回 
			 ...
			 <h4 class="text-center">页面自动 <a id="href" href="water.php">跳转</a> 等待时间： <span id="totalSecond">5</span>
          </div>
