               ...
               <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                     ...
                     <ul class="sub">
                        ...
                        <li ><a href="water.php">施肥日历表</a></li>
...
if(!empty($_FILES)){
	...
	$file_tmp_name=$_FILES['image3']['tmp_name'];
	$image_name="upload/".time().".".substr(strrchr($file_name, '.'), 1);
	move_uploaded_file($file_tmp_name, $image_name);
	}
}
$sql="INSERT INTO water (water_time,water_quantity,water_weather,water_temperature,water_humidity,water_introduce)VALUES(".$_POST['water_time'].",".$_POST['water_quantity'].",".$_POST['water_weather'].",".$_POST['water_temperature'].",".$_POST['water_humidity'].",'".$_POST['water_introduce']."')";
...
?>  
		  ...
		  <a href="water_add.php">
            <button type="button" class="btn btn-info btn-lg">
			点击返回 
            </button>
			</a>
			 <h4 class="text-center">页面自动 <a id="href" href="water_add.php">跳转</a> 等待时间： <span id="totalSecond">5</span>
          </div>
