...
$sql="select * FROM pesticide where pesticide_id=".$_GET['pesticide_id'];
...
if(second<0) location.href='hello.html'; 
	  ...
	  <!-- END META --error_reporting(E_ERROR | E_PARSE); >
            ...
            <section class="wrapper site-min-height">
               <section class="panel">
                  <header class="panel-heading">
                     <span class="label label-primary">农药日历表</span>
                     ...
                     <div class="adv-table editable-table ">
                        ...
                        <table  class="table table-striped table-hover table-bordered" >
                           <thead>
                              <tr>
                                 <th>日期</th>
								 <th class="hidden-phone">药剂种类</th>
                                 <th class="hidden-phone">药剂量/毫升</th>
                                 ...
                                 <th>操作</th>
									  ...
									  <form method="post" class="form-x" action="pesticide_update.php">  
									 <tr>
									<td align="center"><?php echo $row['pesticide_id'] ?>日</td>
									 <td>									  
													<select name="pesticide_species" class="form-control m-bot15">
													  <option  value="0">除虫剂</option>
													  <option  value="1">除草剂</option>
													</select>  
													<input type="hidden" name="pesticide_id" value="<?php echo $_GET['pesticide_id'] ?>">
                                    </td>
									
				
									<td><input type="text" class="form-control small" value="<?php echo $row['pesticide_yield'] ?>" name="pesticide_yield"  />
									    <input type="hidden" name="pesticide_id" value="<?php echo $_GET['pesticide_id'] ?>">
									  </td>
									  
									  <td>
																				  
														<select name="pesticide_weather" class="form-control m-bot15">
									  ...
									  <td><input type="text" class="form-control small" value="<?php echo $row['pesticide_temperature'] ?>" name="pesticide_temperature" data-validate="required:请输入温度" />
									  <input type="hidden" name="id" value="<?php echo $_GET['pesticide_id'] ?>">
									  </td>
									  <td><input type="text" class="form-control small" value="<?php echo $row['pesticide_humidity'] ?>" name="pesticide_humidity" data-validate="required:请输入湿度" />
									  <input type="hidden" name="id" value="<?php echo $_GET['pesticide_id'] ?>">
									  </td>
									  
									<td><button class="label label-success" type="submit"> 提交</button>
									<a class="label label-danger" href="pesticide.php"> 取消</a> </td>
									</form>
